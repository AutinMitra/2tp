...
/// The callback used by [ImprovedReorderableListView] to move an item to a new
/// position in a list.
///
...
/// [ImprovedReorderableListView] will need to account for this when inserting before
/// [newIndex].
///
...
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=3fB1mxOsqJE}
class ImprovedReorderableListView extends StatefulWidget {
  /// Creates a reorderable list.
  ImprovedReorderableListView({
    Key key,
    this.header,
  ...
  /// underlying list.
  ///
  /// This [ImprovedReorderableListView] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _ImprovedReorderableListViewState createState() =>
      _ImprovedReorderableListViewState();
}
...
class _ImprovedReorderableListViewState
    extends State<ImprovedReorderableListView> {
  ...
  final GlobalKey _overlayKey =
      GlobalKey(debugLabel: '$ImprovedReorderableListView overlay key');
...
class _ReorderableListContentState extends State<_ReorderableListContent>
  ...
  static const double _dropAreaMargin = 20.0;
  ...
  Widget _wrap(Widget toWrap, int index, BoxConstraints constraints) {
    ...
    Widget buildDragTarget(BuildContext context, List<Key> acceptedCandidates,
      ...
      Widget child = (widget.enabled)
          ...
          : Container(child: toWrapWithSemantics);
